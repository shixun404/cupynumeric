...
legate --logdir /project/coreai_devtech_all/shixunw/result --launcher none  --cpus 1  --gpus 8 --fbmem 50000 --verbose --log-to-file --nodes 2 --ranks-per-node 1 /project/coreai_devtech_all/shixunw/cupynumeric.internal/test_fancy_indexing.py
